...
const FAQItem = ({ item, isOpen, toggleItem }) => {
  ...
  return (
    ...
    >
      <button
        className={`w-full py-5 px-4 flex justify-between items-center text-left focus:outline-none transition-all duration-200 cursor-pointer ${
          isOpen
      ...
      >
        ...
        >
          <i
            className={`bx ${isOpen ? "bx-minus" : "bx-plus"} ${
      ...
      >
        <div className="p-4 pt-0 pb-5 text-gray-600 dark:text-gray-300">
          <div className="p-3 rounded-lg overflow-y-auto max-h-[300]">
            {item.answer}
          </div>
        </div>
      </div>
